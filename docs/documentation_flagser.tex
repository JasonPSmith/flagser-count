...
\begin{description}
  ...
  \item [-{}-est-max-dim] an estimated value for the maximum dimension, giving a good estimate will make the computations slightly faster (particular when using --containment).
