...
\begin{description}
  ...
  \item [-{}-undirected] computes the \emph{undirected} flag complex instead, by reading in every edge as oriented from smallest to largest index. Currently can only be used with \emph{flagser} or \emph{edge-list} format.
